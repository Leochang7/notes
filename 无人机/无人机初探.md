...
安装教程在[在 ubuntu20.04 中安装 XTdrone 心路历程_xtdrone 语雀-CSDN博客](https://blog.csdn.net/qq_45493236/article/details/135452827)
## 二、概念介绍
#### 1.ROS
##### 是什么
...
按照XTDrone文档编译ego_planner出现一堆错误根据网上内容安装ceres1.14版本，最好安装opencv3,安装opencv3.4.11
解决办法参考：
[Ubuntu20.04从零开始搭建vins-fusion环境并测试数据集](https://tencentcloud.csdn.net/6763963cf3b8a55e4e98dcef.html?dp_token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6MTEwMjgyNCwiZXhwIjoxNzQ4Njg1MTE4LCJpYXQiOjE3NDgwODAzMTgsInVzZXJuYW1lIjoidTAxMjU3MDc2OCJ9.EYTOB-6wHkjPlBAy7bxyYNsFZi8qVjLHfEsATZTH7HQ#devmenu5)
[Ubuntu20.04从零开始搭建vins-mono环境并测试数据集_ubuntu20.04安装vinsmono-CSDN博客](https://blog.csdn.net/Skether/article/details/131571146?login=from_csdn)
[vins-fusion环境配置、安装与测试-CSDN博客](https://blog.csdn.net/qq_52068373/article/details/127871743)
编译ORB-SLAM2时出现问题
![image.png](https://raw.githubusercontent.com/Leochang7/imgGallery/main/img/20250525145650733.png)
解决方案参照
[ORB-SLAM2 安装和编译 及BUG解决方案_orbslam2编译-CSDN博客](https://blog.csdn.net/kakiru/article/details/117466148)
修改文件 **/include/LoopClosing.h** 找到代码
```
Eigen::aligned_allocator<std::pair<con
```
修改为
```
...
修改后成功解决
在编译时又出现问题
![image.png](https://raw.githubusercontent.com/Leochang7/imgGallery/main/img/20250525151816682.png)
